...
The "asm" keyword is optional MY first and is used to suppress the address and opcode portions, only the pure mnemonics and comments are printed
...
My first goal was to find senseful names of subroutines etc. 
